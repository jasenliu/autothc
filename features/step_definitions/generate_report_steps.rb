...
And /^input the (.*) report name$/ do |report_name|
...
Then /^generated report name (.*?) will display on the first line of view status\/report$/ do |report_name|
...
Then /^check report process and download the report$/ do
	report_hash = {
	'exl_Interest Rate Risk (EVE)_201109' => "D:\\exl_Interest Rate Risk (EVE)_201109.xls",
	'exl_Portfolio Analytics_201109' => "D:\\exl_Portfolio Analytics_201109.xls"
}
	check_report(report_hash)
end